...
public class WaypointCreateScreen extends Screen {
    ...
    private static final int[][] COLOR_GRID = {
        ...
        // Row 4: Earthy, Metallic & Specials
    ...
    protected void init() {
        ...
        this.nameField = new EditBox(this.font, centerX - 118, centerY - 60, 212, 18, I18nHelper.getComponent("create.name_label"));
        ...
        this.xField = new EditBox(this.font, centerX - 118, centerY - 24, 68, 18, Component.literal("X"));
        this.xField.setValue(String.valueOf(originalPos.getX()));
        this.addRenderableWidget(this.xField);

        this.yField = new EditBox(this.font, centerX - 34, centerY - 24, 68, 18, Component.literal("Y"));
        this.yField.setValue(String.valueOf(originalPos.getY()));
        this.addRenderableWidget(this.yField);

        this.zField = new EditBox(this.font, centerX + 50, centerY - 24, 68, 18, Component.literal("Z"));
        ...
        this.addRenderableWidget(
            ModernButton.modernBuilder(Component.literal(""), btn -> {
                this.minecraft.setScreenAndShow(new WaypointListScreen(this));
    ...
    public void extractRenderState(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a) {
        ...
        graphics.text(this.font, I18nHelper.getComponent("create.name_label"), centerX - 118, centerY - 72, 0xFFA0A0A0);
        graphics.text(this.font, I18nHelper.getComponent("create.coordinates_label"), centerX - 118, centerY - 36, 0xFFA0A0A0);
        ...
        for (int r = 0; r < COLOR_GRID.length; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                if (isHovered) {
                    graphics.fill(btnX, btnY, btnX + 13, btnY + 13, 0x603D4966);
                }
        ...
        graphics.blit(pipeline, shareDimIcon, centerX + 100, centerY - 60, 0.0f, 0.0f, 18, 18, 18, 18);

        graphics.blit(pipeline, ICON_CANCEL, centerX - 116, centerY + 67, 0.0f, 0.0f, 18, 18, 18, 18);
        graphics.blit(pipeline, ICON_LIST, centerX + 98, centerY + 67, 0.0f, 0.0f, 18, 18, 18, 18);
    }
